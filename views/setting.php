...
<?php $form_action = $this->getSubmitFormAction(); ?>
<div class="wrap">
    ...
    <div id="migration-page">
        <div class="page-header">
            ...
            <div class="redirect-icon"><a href="<?php echo $this->getPluginPage() ?>" title="Migration"><span class="icon-migrate"></span></a></div>
        </div>
        ...
        <div class="migration-content">
            ...
            <div id="setting-wrap" class="wrap-box">
                <form id="setting-form" action="<?php echo $form_action; ?>" method="POST" enctype="application/x-www-form-urlencoded">
                    <input type="hidden" name="action" value="dwem_setting_form">
